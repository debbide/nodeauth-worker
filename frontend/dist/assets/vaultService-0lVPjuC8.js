const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Dm41BLkj.js","assets/pdf-utils-r4RjNe6V.js","assets/compression-utils-CXh1ITwj.js","assets/vue-core-Daban9YF.js","assets/element-plus-Dh0klhaa.js","assets/element-plus-Dh61In7b.css","assets/simplewebauthn-3qpiAaRi.js","assets/tanstack-query-C-OQsQoR.js","assets/index-CKCC89YU.css"])))=>i.map(i=>d[i]);
import { _ as q, __tla as __tla_0 } from "./pdf-utils-r4RjNe6V.js";
import { n as F, o as H, l as z, r as y, b as G, p as w, u as K, s as J, g as W, q as _, a as N, __tla as __tla_1 } from "./index-Dm41BLkj.js";
import { l as x, __tla as __tla_2 } from "./resourceRegistry-BcZxmsTZ.js";
        ...
        async getTrashList () {
            ...
            try {
                const { useLayoutStore: r } = await q(async ()=>{
                    const { useLayoutStore: o } = await import("./index-Dm41BLkj.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((i)=>i.x);
                    return {
                        ...
                        if (!h?.success) {
                            ...
                            if (b) {
                                ...
                                const { useOfflineStore: S } = await q(async ()=>{
                                    const { useOfflineStore: g } = await import("./index-Dm41BLkj.js").then(async (m)=>{
                                        await m.__tla;
                                        return m;
                                    }).then((T)=>T.y);
                                    return {
