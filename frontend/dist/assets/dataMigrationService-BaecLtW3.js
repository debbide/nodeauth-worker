...
import { n as ae, p as K, v as le, b as ee, O as fe, __tla as __tla_1 } from "./vaultService-DHLTMMTt.js";
import { l as N, d as me, e as we, __tla as __tla_2 } from "./index-A5gCNzyQ.js";
    ...
    const Fe = {
        decodePayload (r) {
            ...
            for(; t < r.length;){
                ...
                if (s === 1 && a === 2) {
                    const i = e(), f = t + i;
                    let w = null, p = "", _ = "", m = "SHA1", E = 6, T = "totp", u = 0;
                    for(; t < f;){
                        ...
                        if (c === 1 && d === 2) {
                            ...
                            const l = e();
                            p = new TextDecoder().decode(r.slice(t, t + l)), t += l;
                        } else if (c === 3 && d === 2) {
                            const l = e();
...
`).filter((u)=>u.trim());
            ...
            const t = this._splitCsvLine(o[0]).map((u)=>u.toLowerCase()), e = [], y = t.includes("login_totp"), s = t.includes("otpauth") && !t.includes("title"), a = t.includes("otpauth") && t.includes("title"), i = t.includes("totp") && t.includes("vault") && t.includes("createtime"), f = t.includes("otpurl") && t.includes("title") && t.includes("username"), w = t.includes("issuer") || t.includes("secret") || t.includes("name"), p = [
                "otpauth",
                "login_totp",
                "totp",
                "mfa",
                ...
                "account",
                "email"
            ], E = (u)=>u ? u.toString().trim().replace(/[\s-]/g, "").toUpperCase() : "", T = t.some((u)=>p.includes(u));
            if (!y && !s && !a && !i && !f && !w && !T) return [];
            for(let u = 1; u < o.length; u++){
                const n = this._splitCsvLine(o[u]), c = {};
                if (t.forEach((d, l)=>{
                    c[d] = n[l] || "";
                }), a) {
                    ...
                    const d = t.find((g)=>p.includes(g)), l = d ? (c[d] || "").trim() : "";
            ...
            (function(t) {
                function y(u) {
                    ...
                    function I(H) {
                        let Q = 0, B = H.length;
                        for(; B >= 64;){
                            let M = c, W = d, z = l, j = g, v = h, V = A, F = S, q = b, k, U, X, Z, re;
                            for(U = 0; U < 16; U++)X = Q + U * 4, O[U] = (H[X] & 255) << 24 | (H[X + 1] & 255) << 16 | (H[X + 2] & 255) << 8 | H[X + 3] & 255;
                            for(U = 16; U < 64; U++)k = O[U - 2], Z = (k >>> 17 | k << 15) ^ (k >>> 19 | k << 13) ^ k >>> 10, k = O[U - 15], re = (k >>> 7 | k << 25) ^ (k >>> 18 | k << 14) ^ k >>> 3, O[U] = (Z + O[U - 7] | 0) + (re + O[U - 16] | 0) | 0;
                            ...
                            c = c + M | 0, d = d + W | 0, l = l + z | 0, g = g + j | 0, h = h + v | 0, A = A + V | 0, S = S + F | 0, b = b + q | 0, Q += 64, B -= 64;
                        }
                    }
                    I(u);
                    let P, D = u.length % 64, L = u.length / 536870912 | 0, C = u.length << 3, G = D < 56 ? 56 : 120, R = u.slice(u.length - D, u.length);
                ...
                function a(u, n, c, d, l) {
                    let g;
                    for(p(u, (2 * c - 1) * 16, l, 0, 16), g = 0; g < 2 * c; g++)w(u, g * 16, l, 16), f(l, d), p(l, 0, u, n + g * 16, 16);
                    for(g = 0; g < c; g++)p(u, n + g * 2 * 16, u, g * 16, 16);
                    for(g = 0; g < c; g++)p(u, n + (g * 2 + 1) * 16, u, (g + c) * 16, 16);
                }
                function i(u, n) {
                    return u << n | u >>> 32 - n;
                }
                function f(u, n) {
                    ...
                    for(let c = 0; c < 16; ++c)u[c] += n[c];
                }
                function w(u, n, c, d) {
                    for(let l = 0; l < d; l++)c[l] ^= u[n + l];
                }
                function p(u, n, c, d, l) {
                    for(; l--;)c[d++] = u[n++];
                }
                function _(u) {
                ...
                function m(u, n) {
                    if (typeof u != "number" || u % 1) throw new Error("invalid " + n);
                    return u;
                }
                function E(u, n, c, d, l, g, h) {
                    ...
                    if (!_(u)) throw new Error("password must be an array or buffer");
                    if (u = Array.prototype.slice.call(u), !_(n)) throw new Error("salt must be an array or buffer");
                    ...
                    let C = 0, G = null, R = !1, H = 0, Q = 0, B, M;
                    const W = h ? parseInt(1e3 / d) : 4294967295, z = typeof setImmediate < "u" ? setImmediate : setTimeout, j = function() {
                        ...
                        switch(H){
                            case 0:
                                M = Q * 32 * d, p(S, M, b, 0, I), H = 1, B = 0;
                            case 1:
                                v = c - B, v > W && (v = W);
                                for(let F = 0; F < v; F++)p(b, 0, O, (B + F) * I, I), a(b, I, d, P, D);
                                if (B += v, C += v, h) {
                            ...
                            case 2:
                                v = c - B, v > W && (v = W);
                                for(let F = 0; F < v; F++){
                                    const q = (2 * d - 1) * 16, k = b[q] & c - 1;
                                    w(O, k * I, b, I), a(b, I, d, P, D);
                                }
                                if (B += v, C += v, h) {
                                    const F = parseInt(1e3 * C / L);
                                    if (F !== G) {
                ...
                const T = {
                    scrypt: function(u, n, c, d, l, g, h) {
                        return new Promise(function(A, S) {
                            let b = 0;
                            h && h(0), E(u, n, c, d, l, g, function(O, I, P) {
                                if (O) S(O);
                    ...
                    syncScrypt: function(u, n, c, d, l, g) {
                        return new Uint8Array(E(u, n, c, d, l, g));
                    }
                };
                r.exports = T;
            })();
    ...
    const Re = {
        async decryptDatabase (r, o) {
            ...
            for (const m of t)if (m.type === 1) {
                const E = Y(m.salt), T = await Ne.scrypt(a, E, m.n, m.r, m.p, 32), u = Y(m.key), n = Y(m.key_params.nonce), c = Y(m.key_params.tag), d = new Uint8Array(u.length + c.length);
                d.set(u), d.set(c, u.length);
                try {
            ...
            const i = Le(e), f = Y(y.nonce), w = Y(y.tag), p = new Uint8Array(i.length + w.length);
            p.set(i), p.set(w, i.length);
        ...
        async parse (r, o) {
            ...
            try {
                ...
                const i = a.slice(0, 12), f = a.slice(12), p = (await pe.hash({
                    pass: o,
                    salt: y,
                    time: 2,
                    mem: 19 * 1024,
                    ...
                    distPath: "/"
                })).hash, _ = await window.crypto.subtle.importKey("raw", p, {
                    name: "AES-GCM"
                }, !1, [
                    "decrypt"
                    ...
                    additionalData: m,
                    tagLength: 128
                }, _, f), T = new TextDecoder().decode(E), u = JSON.parse(T);
        ...
        async parse (r, o) {
            try {
                ...
                for(const w in f){
                    const _ = f[w].items || [];
                    for (const m of _){
                        const E = m.data || {}, T = E.content || {}, u = E.metadata || {};
                        if (T.totpUri) {
                            const n = K(T.totpUri);
                            n && (u.name && (n.service = u.name), T.itemUsername && (n.account = T.itemUsername), i.push(n));
                        }
                    }
                }
                return i;
        ...
        async decryptAndParse (r, o) {
            ...
            let p;
            try {
                const T = await Me(), u = T.crypto_secretstream_xchacha20poly1305_init_pull(y, w), n = T.crypto_secretstream_xchacha20poly1305_pull(u, s);
                if (!n || !n.message) throw new Error("no result");
                p = n.message;
            } catch  {
                throw new Error("INVALID_FORMAT_OR_PASSWORD");
            }
            const m = new TextDecoder().decode(p).split(`
`), E = [];
            for (const T of m){
                const u = T.trim();
...
`)[0].toLowerCase() : "";
        ...
        async exportData (r, o, t, e = "generic") {
                ...
                const i = r.map((f, w)=>{
                    ...
                    return {
                        ...
                        otp: {
                            source: "manual",
                            account: f.account || "",
                            digits: p ? 5 : f.digits || 6,
                            period: f.period || 30,
                            algorithm: f.algorithm || "SHA1",
                            tokenType: p ? "STEAM" : f.type?.toUpperCase() || "TOTP",
                            counter: f.counter || 0
                        },
                        order: {
                            position: w
            ...
            if (o === "aegis") {
                const i = new Map;
                r.forEach((p)=>{
                    p.category && !i.has(p.category) && i.set(p.category, crypto.randomUUID());
                });
                const f = Array.from(i.entries()).map(([p, _])=>({
                        name: p,
                        uuid: _
                    })), w = r.map((p)=>{
                    const _ = [];
                    p.category && i.has(p.category) && _.push(i.get(p.category));
                    const m = (p.type || "totp").toLowerCase(), E = {
                        secret: p.secret,
                        algo: p.algorithm || "SHA1",
                        digits: m === "steam" ? 5 : p.digits || 6
                    };
                    return m === "hotp" ? E.counter = p.counter || 0 : E.period = p.period || 30, {
                        type: m,
                        uuid: crypto.randomUUID(),
                        name: p.account || p.service,
                        issuer: p.service,
                        info: E,
                        groups: _
                    };
            ...
            if (o === "proton_auth") {
                const i = {
                    version: 1,
                    entries: r.map((f)=>{
                        const w = f.type === "steam", p = w ? `steam://${f.secret}` : ee(f);
                        return {
...
`;
                return r.forEach((f)=>{
                    const w = `"${f.service}${f.account ? ":" + f.account : ""}"`, p = f.type === "steam" ? `steam://${f.secret}` : ee(f);
                    i += `${w},${f.secret},"${p}",0,
`;
                }), i;
            }
...
`;
                return r.forEach((f)=>{
                    const w = f.account || "", p = f.service || "", _ = f.type?.toUpperCase() || "TOTP", m = f.category || "";
                    i += `"${w}","${p}",${f.secret},${f.algorithm || "SHA1"},${f.digits || 6},${f.period || 30},${_},${f.counter || 0},"${m}"
`;
                }), i;
            }
        ...
        async exportAsGaMigration (r) {
            ...
            if (r = r.filter((p)=>o.includes((p.type || "totp").toLowerCase())), r.length === 0) throw new x("所选账号的类型 Google Authenticator 均不支持", "EMPTY_VAULT");
            const t = 10, e = [];
            for(let p = 0; p < r.length; p += t)e.push(r.slice(p, p + t));
            const y = Math.floor(Math.random() * 2147483647), s = await ce(()=>import("./qr-utils-ZD31REeY.js").then((p)=>p.b), __vite__mapDeps([0,1,2,3])), a = [];
            function i(p, _) {
                for(; p >= 128;)_.push(p & 127 | 128), p >>>= 7;
                _.push(p);
            }
            function f(p, _) {
            ...
            function w(p, _) {
                i(p.length, _);
                for(let m = 0; m < p.length; m++)_.push(p[m]);
            }
            for(let p = 0; p < e.length; p++){
                const _ = e[p], m = [];
                m.push(16), i(1, m), m.push(24), i(e.length, m), m.push(32), i(p, m), m.push(40), i(y, m);
                for (const n of _){
                ...
                const T = `otpauth-migration://offline?data=${encodeURIComponent(btoa(E))}`, u = await s.toDataURL(T, {
...
`);
        ...
        async decrypt2FasEncrypted (r, o) {
            try {
                ...
                let i, f, w;
                const p = s.findIndex((l)=>l.length === $.IV_LEN);
                if (p !== -1 && (f = s.splice(p, 1)[0], s.length > 0)) {
                    let l = 0;
                ...
                const T = w.slice(w.length - 16), u = w.slice(0, w.length - 16), n = await crypto.subtle.decrypt({
                    name: "AES-GCM",
                    iv: f
                }, E, new Uint8Array([
                    ...u,
        ...
        async decryptBitwardenPassEncrypted (r, o) {
            try {
                ...
                const s = new TextEncoder().encode(t), a = new TextEncoder().encode(r), i = await crypto.subtle.importKey("raw", a, {
                    ...
                    iterations: e,
                    hash: "SHA-256"
                }, i, 256), w = new Uint8Array(f), p = await this._hkdfExpandSha256(w, "enc", 32), _ = await this._hkdfExpandSha256(w, "mac", 32), m = async (u, n, c)=>{
                    const d = u.split(".");
                ...
                if (!await m(o.encKeyValidation_DO_NOT_EDIT, p, _)) throw new Error("MAC verification failed");
                const T = await m(o.data, p, _);
                return JSON.parse(T);
            } catch (t) {
        ...
        async _hkdfExpandSha256 (r, o, t) {
            ...
            for(; i < t;){
                ...
                const p = Math.min(a.length, t - i);
                s.set(a.slice(0, p), i), i += p, f++;
            }
            return s;
        },
        bytesToBase32 (r) {
        ...
        async parsePhoneFactor (r) {
            ...
            try {
                ...
                const a = Ie(s);
                console.log("[PhoneFactor] sqlite3 Factory 完成"), y = new Be;
                ...
                w(f, o);
                const p = t && t.byteLength > 0;
                p && w(`${f}-wal`, t), e && e.byteLength > 0 && w(`${f}-shm`, e), console.log("[PhoneFactor] 注入文件到 VFS 完成", {
                    main: f,
                    hasWal: p,
        ...
        async parseGaQrImageFile (r) {
            return new Promise((o, t)=>{
                ...
                e.onload = ()=>{
                    ...
                    let f = null;
                    for (const p of i){
                        s.width = e.width * p, s.height = e.height * p, a.imageSmoothingEnabled = !1, a.drawImage(e, 0, 0, s.width, s.height);
                    ...
                    try {
                        ...
                        for(let u = 0; u < E.length; u++)T[u] = E.charCodeAt(u);
                        o(Fe.decodePayload(T));
                    } catch (p) {
                        t(new x("解析 Google Authenticator 数据失败", "GA_DECODE_FAILED", p));
                    }
                }, e.onerror = ()=>{
        ...
        async parse1Pux (r) {
            try {
                ...
                return (s.accounts || []).forEach((f)=>{
                    (f.vaults || []).forEach((p)=>{
                        (p.items || []).forEach((m)=>{
                            const E = m.overview?.title || "Unknown", T = m.overview?.subtitle || "", u = (n)=>{
                            ...
                            u(m.details?.loginFields), Array.isArray(m.details?.sections) && m.details.sections.forEach((n)=>u(n.fields));
                        });
                    });
                }), a;
            } catch (o) {
